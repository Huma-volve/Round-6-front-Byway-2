  ...
  reviews:[
    {
      ...
      student_name:"sara ",
      rating:4,
      comment:"Lorem, ipsum dolor sit amet consectetur adipisicing elit. Consequatur nihil aliquid quibusdam nulla id voluptatum ullam veritatis perferendis, harum explicabo fuga ipsam asperiores sapiente. Expedita omnis nihil sit reprehenderit eos.",
    ...
    <div>
      <div className="container mx-auto px-10 sm:p-0">
        ...
        <div className="">
          ...
          <p className="text-green font-semibold text-2xl py-4">{details.price} EGP</p>
          <Button className="text-white bg-green hover:bg-green-600 px-14 py-6 text-2xl border rounded-lg ">Buy Now</Button>
        </div>
        <div className="">
          <Button onClick={()=>toggleShowLesson()} variant="outline" className="text-xl font-semibold border border-blue rounded-lg px-7 py-3 my-10">Content</Button>
          {showLesson && details.content?.map((lesson ,index)=>(
            <div className="border px-5 py-3 my-3 rounded-lg w-fit flex items-center gap-2 text-xl font-medium">
               <div className="border rounded-lg p-3 "><BiRightArrow/></div>              
