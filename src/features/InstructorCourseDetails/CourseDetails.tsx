  ...
  return (
    ...
    <div className=' my-5'>
        ...
        <div className="w-full">
            <h2 className="py-2 text-4xl font-semibold">{course?.data.course.title}</h2>
            <p className="text-gray-500 font-medium w-[80%] text-xl mb-2">{course?.data.course.description}</p>
        </div>
