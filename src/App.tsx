...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "/student/instructordetails",
      ...
      { path: "/instructor/Review", element: <Review /> },
      { path: "/instructor/Revenue", element: <Revenue /> },
      { path: "/instructor/PayoutDetails", element: <PayoutDetails /> },
      {
        path: "/instructor/NotificationsEmptyIns",
        element: <NotificationsEmptyIns />,
      },
      { path: "/instructor/WithDraw", element: <WithDraw /> },
