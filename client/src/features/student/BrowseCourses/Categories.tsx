...
export default function Categories() {
  ...
  return (
    <div
      ...
      } container mx-auto px-10 sm:p-0`}
    >
      ...
      <div className="grid  sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {categories.map((category) => (
          <div
            key={category.id}
            className="border border-gray-[#E2E8F0] text-center p-5 rounded-xl shadow shadow-blue-500/12 grid gap-4"
          >
            <span className="bg-blue-100 rounded-full inline-block p-4 w-fit mx-auto">
              <HiMiniComputerDesktop className="text-blue-website" />
            </span>
